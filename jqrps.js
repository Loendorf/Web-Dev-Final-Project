...
function rpschoice(choice1)
{
  function computerChoice(min, max)
  {
    ...
    computerChoice(1,16);
      ...
      if (choice1 = 'fire')
        {
      if (choice2 === 3 || choice2 === 4 || choice2 ===  5 || choice2 === 6 || choice2 === 7 || choice2 === 8 || choice2 === 9)
            {
              document.getElementById('win').innerHTML="A winner is you!";
            }
      else if (choice2 === 10 || choice2 === 11 || choice2 ===  12 || choice2 === 13 || choice2 === 14 || choice2 === 15 || choice2 === 1)
            {
              document.getElementById('lose').innerHTML="Ya lose bruv!";
            }
      else
